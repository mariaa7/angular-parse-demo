...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'Ct3IqwEmLlfrfsp1aLaShsjEPEy1yE0uiwfgZl9F';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'qvCa7SmLJ7qIignt0GATSvAD2XZTN25AWwBwlMD6';
    })
    .controller('TasksController', function($scope, $http) {
        ...
        //get or refresh all objects saved by my app
